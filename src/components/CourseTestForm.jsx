// src/components/CourseTestForm.jsx
...
export const CPCM_TEST_QUESTIONS = [
    { id: 'q1', text: '1. كم من الزمن يجب ان يظل الطفل السليم ملتصقاً بأمه جلدا بجلد ؟', type: 'mc', options: [{ id: 'a', text: 'ساعة واحدة علي الأقل' }, { id: 'b', text: 'لأي فترة اذا كان ذلك لا يسبب ازعاجا أو ارهاقا للأم' }, { id: 'c', text: 'فقط الى حين ان تصبح درجة الحرارة طبيعية' }, { id: 'd', text: 'لمدة 24 ساعة على الأقل' }], correctAnswer: 'a' },
    { id: 'q2', text: '2. خلال الساعة الأولى بعد الولادة ما هي الفترات الزمنية اللازمة لمراقبة التنفس للطفل الوليد ؟', type: 'mc', options: [{ id: 'a', text: 'مرة واحدة خلال تلك الساعة' }, { id: 'b', text: 'كل 30 دقيقة' }, { id: 'c', text: 'كل 15 دقيقة' }, { id: 'd', text: 'كل 5 دقائق' }], correctAnswer: 'c' },
    { id: 'q3', text: '3. لماذا كان من الضروري أن تبدأ الرضاعة الطبيعية خلال الساعة الأولى بعد الولادة ؟', type: 'mc', options: [{ id: 'a', text: 'لأنها تتيح للطفل اتمام الرضاعة الطبيعية بنجاح.' }, { id: 'b', text: 'تقلل من بكاء الطفل' }, { id: 'c', text: 'تحافظ على بقاء الطفل يقظاً بعد الولادة' }, { id: 'd', text: 'تساعد الوليد علي التنفس بسهولة' }], correctAnswer: 'a' },
    { id: 'q4', text: '4. متي يجب اعطاء الطفل سوائل غير لبن الأم ؟', type: 'mc', options: [{ id: 'a', text: 'عندما لا يستطيع الطفل الرضاعة من الثدي في الساعة الأولي بعد الولادة' }, { id: 'b', text: 'عندما تعانى الأم من احتقان الثدى' }, { id: 'c', text: 'عندما يبكي الطفل بين الرضعات' }, { id: 'd', text: 'لا تعطي سوائل اطلاقا' }], correctAnswer: 'd' },
    { id: 'q5', text: '5. ما هی اولی علامات استعداد الطفل للرضاعة ؟', type: 'mc', options: [{ id: 'a', text: 'البكاء لفترة طويلة' }, { id: 'b', text: 'فتح الفم واللحس' }, { id: 'c', text: 'العيون مغلقة والكفان مفتوحتان' }, { id: 'd', text: 'تنفس سريع مع فم مفتوح' }], correctAnswer: 'b' },
    { id: 'q6', text: '6. ما هى سرعة تنفس الطفل الوليد السليم ؟', type: 'mc', options: [{ id: 'a', text: '65 / الدقيقة على الأقل' }, { id: 'b', text: 'أي سرعة طالما ليس هناك انسحاب في الصدر' }, { id: 'c', text: '40-60 / نفس في الدقيقة' }, { id: 'd', text: '25 / نفس في الدقيقة' }], correctAnswer: 'c' },
    { id: 'q7', text: '7. ما هي أهمية وزن كل الأطفال بعد الولادة بفترة وجيزة ؟', type: 'mc', options: [{ id: 'a', text: 'الوزن قد يحدد الأطفال الذين يحتاجون الي عناية خاصة' }, { id: 'b', text: 'الأم والعائلة غالبا يحتاجون معرفة وزن الطفل' }, { id: 'c', text: 'وزن الطفل يحدد زمن الرضاعة الطبيعية اللازم في كل رضعة' }, { id: 'd', text: 'يحدد الوزن الأطفال الذين سيحتاجون فيتامين ك' }], correctAnswer: 'a' },
    { id: 'q8', text: '8. في أي جزء من العين يجب وضع دواء لمنع عدوي العينين ؟', type: 'mc', options: [{ id: 'a', text: 'داخل الجفن العلوي' }, { id: 'b', text: 'داخل الجفن السفلى' }, { id: 'c', text: 'في ركن العين فقط' }, { id: 'd', text: 'في خارج الجفن' }], correctAnswer: 'b' },
    { id: 'q9', text: '9. ما هي درجة الحرارة الطبيعية لطفل سليم ؟', type: 'mc', options: [{ id: 'a', text: '36.5°C-37.5°C' }, { id: 'b', text: '34.0°C-35.5°C' }, { id: 'c', text: '35.5°C-36.5°C' }, { id: 'd', text: '37.5°C-38.5°C' }], correctAnswer: 'a' },
    { id: 'q10', text: '10. أي الأطفال يجب اعطاؤهم فايتامين ك ؟', type: 'mc', options: [{ id: 'a', text: 'الأطفال الذين يصابون بالنزيف فقط' }, { id: 'b', text: 'الأطفال الذين يكون وزنهم اكثر من 2500 جم فقط' }, { id: 'c', text: 'كل الأطفال' }, { id: 'd', text: 'الأطفال المرضى فقط' }], correctAnswer: 'c' },
    { id: 'q11', text: '11. كيف يمكن ابقاء الطفل دافئاً بعد الالتصاق جلد بجلد ؟', type: 'mc', options: [{ id: 'a', text: 'تحميم الطفل بماء دافيء' }, { id: 'b', text: 'لف الطفل فى فوطة او قطعة قماش نظيفة دافئة' }, { id: 'c', text: 'وضعه بجانب احجار دافئة' }, { id: 'd', text: 'تعريضه للشمس' }], correctAnswer: 'b' },
    { id: 'q12', text: '12. ما هو التوقيت المناسب لتحميم الطفل السليم بعد الولادة ؟', type: 'mc', options: [{ id: 'a', text: 'متى ما كانت حرارة الطفل طبيعية' }, { id: 'b', text: 'متى ما كان التنفس طبيعيا' }, { id: 'c', text: 'بعد 6 ساعات من الولادة على الأقل' }, { id: 'd', text: 'مباشرة بعد أول رضعة من الثدي' }], correctAnswer: 'c' },
    { id: 'q13', text: '13. من علامات التعلق الجيد بالثدى في الرضاعة', type: 'mc', options: [{ id: 'a', text: 'انف الطفل ضاغط على الثدى' }, { id: 'b', text: 'الطفل يعض ويجذب حلمة الثدي الي الأسفل' }, { id: 'c', text: 'طرف الثدي فقط في فم الطفل' }, { id: 'd', text: 'فم الطفل مفتوح واسعا فوق الثدى' }], correctAnswer: 'd' },
    { id: 'q14', text: '14. كيف تتصرف الأم التي تعاني من احتقان الثدى ؟', type: 'mc', options: [{ id: 'a', text: 'ترضع طفلها أكثر أو تفرغ او تشفط الثدي' }, { id: 'b', text: 'توقف الرضاعة من الثدي ليوم واحد' }, { id: 'c', text: 'تستعمل مضادات حيوية' }, { id: 'd', text: 'تمسح الثدى من مسحوق الأعشاب' }], correctAnswer: 'a' },
    { id: 'q15', text: '15. ولد طفل وزنه 2700 جم وتم وضعه مباشرة فوق صدر أمه جلدا بجلد . بعد 90 دقيقة كانت درجة حرارته 36 ماهي الخطوة التالية الواجب اتباعها ؟', type: 'mc', options: [{ id: 'a', text: 'اعطيه مضادات حيوية وقومي باحالته للعناية المتقدمة' }, { id: 'b', text: 'لا يحتاج لعناية خاصة لأن درجة حرارته طبيعية' }, { id: 'c', text: 'تدفئة الغرفة وسد منافذ التيارات الهوائية وابعاد الملابس المبتلة' }, { id: 'd', text: 'وضع أحجار دافئة بجانب الطفل' }], correctAnswer: 'c' },
    { id: 'q16', text: '16. يحتاج الأطفال الي التغذية بالحليب عن طريق الكوب عندما :', type: 'mc', options: [{ id: 'a', text: 'يعانون من الاستفراغ بعد كل رضعة' }, { id: 'b', text: 'لا يستيقظون من النوم حين يحل وقت الرضاعة' }, { id: 'c', text: 'يكون الابتلاع عندهم طبيعي ولكن قوة الرضاعة والامتصاص ضعيفة' }, { id: 'd', text: 'ليس لهم القدرة على الابتلاع' }], correctAnswer: 'c' },
    { id: 'q17', text: '17. الخطوة الصحيحة عند تغذية الطفل بواسطة الكوب هي:', type: 'mc', options: [{ id: 'a', text: 'ترك الطفل يلعق ( يلحس ) الحليب من الكوب' }, { id: 'b', text: 'سكب كميات قليلة من الحليب في فم الطفل' }, { id: 'c', text: 'وضع الطفل مسطحا على ظهره' }, { id: 'd', text: 'سكب الحليب بانسياب في فم الطفل' }], correctAnswer: 'a' },
    { id: 'q18', text: '18. من صفات التشنجات عند الوليد أنها :', type: 'mc', options: [{ id: 'a', text: 'تحدث فقط في الساقين' }, { id: 'b', text: 'لا يمكن ايقافها بتثبيت اليدين والساقين' }, { id: 'c', text: 'تحدث کرد فعل لضجة عالية' }, { id: 'd', text: 'تحدث فقط عندما يكون الطفل مستيقظا' }], correctAnswer: 'b' },
    { id: 'q19', text: '19. متي يجب معالجة الطفل بالمضادات الحيوية ؟', type: 'mc', options: [{ id: 'a', text: 'اذا كان الوزن عند الولادة أقل من 2000 جم' }, { id: 'b', text: 'عند وجود علامة خطورة' }, { id: 'c', text: 'اذا كان الطفل يصرخ باستمرار' }, { id: 'd', text: 'اذا كان الطفل يبدو في حالة الم' }], correctAnswer: 'b' },
    { id: 'q20', text: '20. متى يجب اعطاء الجرعة الأولي من المضاد الحيوى ؟', type: 'mc', options: [{ id: 'a', text: 'بعد الاحالة للعناية المتقدمة' }, { id: 'b', text: 'في أقرب وقت ممكن بعد التعرف على علامة خطورة' }, { id: 'c', text: 'بعد الاتصال بكل أفراد العائلة' }, { id: 'd', text: 'في الوقت الذي يناسب مقدم الخدمة الصحية' }], correctAnswer: 'b' },
    { id: 'q21', text: '21. بعد انقضاء اليوم الأول بعد الولادة يعتبر اليرقان شديدا عندما يغطى من الجسم', type: 'mc', options: [{ id: 'a', text: 'الظهر والبطن' }, { id: 'b', text: 'بياض العين' }, { id: 'c', text: 'الساقين والذراعين' }, { id: 'd', text: 'باطن الكفين والقدمين' }], correctAnswer: 'd' },
    { id: 'q22', text: '22. كم مرة تعتصر الأم الحليب لطفلها الذي لا يستطيع الرضاعة من ثديها ؟', type: 'mc', options: [{ id: 'a', text: 'متى ما اراد الرضاعة ( 12 مرة 24 ساعة )' }, { id: 'b', text: '3 مرات خلال النهار فقط' }, { id: 'c', text: 'مرة واحدة صباحا ومرة قبل النوم' }, { id: 'd', text: '4 مرات كل ساعة' }], correctAnswer: 'a' },
    { id: 'q23', text: '23. طفل وزنه 3000 جم لم يستطع الرضاعة والبلع خلال ال 6 ساعات الأولى بعد الولادة كيف تصنفين هذا الطفل وما الواجب عمله ؟', type: 'mc', options: [{ id: 'a', text: 'الطفل طبيعي ، ويجب تشجيع الرضاعة الطبيعية' }, { id: 'b', text: 'الطفل عنده علامة خطورة ويحتاج الى عناية متقدمة' }, { id: 'c', text: 'الطفل عنده مشكلة تغذية ويحتاج الي تغذية بواسطة الكوب' }, { id: 'd', text: 'الطفل على الأرجح سيموت ، ويجب التوقف عن تقديم أي رعاية اضافية' }], correctAnswer: 'b' },
    { id: 'q24', text: '24. أي هذه العلامات تدل على أن الطفل يتلقى رضاعة كافية من الثدى ؟', type: 'mc', options: [{ id: 'a', text: 'الطفل يصرخ خلال ساعة بعد كل رضعة' }, { id: 'b', text: 'الرضاعة بقوة بحيث تسبب ألما في حلمة الثدى مع كل رضعة' }, { id: 'c', text: 'الطفل يظل صاحياً ونشطاً عقب كل رضعة' }, { id: 'd', text: 'الرضاعة 8 - 10 مرات يوميا' }], correctAnswer: 'c' },
    { id: 'q25', text: '25. طفل وليد وزنه 1800 جم يحتاج العلاج بالمضاد الحيوي ما هي الجرعة اللازمة من الامبسلين (200 ملج مل ) التي يجب اعطاؤها ؟', type: 'mc', options: [{ id: 'a', text: '0.6 مل' }, { id: 'b', text: '0.5 مل' }, { id: 'c', text: '1.0 مل' }, { id: 'd', text: '0.35 مل' }], correctAnswer: 'a' },
    { id: 'q26', text: '26. في الدقيقة الاولي بعد الولادة يتوجب عليك :', type: 'mc', options: [{ id: 'a', text: 'تحميم الطفل.' }, { id: 'b', text: 'مساعدة الوليد على التنفس.' }, { id: 'c', text: 'ارضاع الطفل.' }, { id: 'd', text: 'عدم لمس الطفل' }], correctAnswer: 'b' },
    { id: 'q27', text: '27. في التحضير للولادة :', type: 'mc', options: [{ id: 'a', text: 'قومي باختيار مساعدة ومراجعة خطة الطواري .' }, { id: 'b', text: 'اطلبي من كل الحضور عدا الام مقادرة المكان.' }, { id: 'c', text: 'حضري المعدات عند الحاجة فقط .' }, { id: 'd', text: 'لا تحتاجين لمساعدة.' }], correctAnswer: 'a' },
    { id: 'q28', text: '28. في تحضير المكان :', type: 'mc', options: [{ id: 'a', text: 'افتحي كل الابواب والشبايك لادخال هواء نقي .' }, { id: 'b', text: 'ليس هنالك حاجة للمكان النظيف للوليد .' }, { id: 'c', text: 'تاكدي ان المكان نظيف ودافئ والاضاءة كافية .' }, { id: 'd', text: 'حافظي علي درجة برودة الغرفة .' }], correctAnswer: 'c' },
    { id: 'q29', text: '29. اي من الاطفال يحتاج لرعاية عادية بعد الولادة ؟', type: 'mc', options: [{ id: 'a', text: 'طفل لا يتنفس .' }, { id: 'b', text: 'طفل يشهق.' }, { id: 'c', text: 'طفل يصرخ ويتنفس جيدا' }, { id: 'd', text: 'طفل مرتخي العضلات .' }], correctAnswer: 'c' },
    { id: 'q30', text: '30. الرعاية العادية الروتينية لطفل سليم عند الولادة تشمل :', type: 'mc', options: [{ id: 'a', text: 'التجفيف وإزالة الفوطة المبتلة وتحميم الطفل.' }, { id: 'b', text: 'التجفيف وإزالة الفوطة المبتلة ووضع الطفل جلد بجلد .' }, { id: 'c', text: 'تحميم الطفل والباسة ملابس جديدة' }, { id: 'd', text: 'تجفيف ولف الطفل بالقطعة المبتلة' }], correctAnswer: 'b' },
    { id: 'q31', text: '31. متي يجب شبك او ربط وقطع الحبل السري اثناء الرعاية العادية ؟', type: 'mc', options: [{ id: 'a', text: 'بعد خروج المشيمة' }, { id: 'b', text: 'بعد الولادة ب 1-3 دقائق .' }, { id: 'c', text: 'مباشرة بعد الولادة' }, { id: 'd', text: 'قبل ان يصرخ الطفل .' }], correctAnswer: 'b' },
    { id: 'q32', text: '32. طفل صامت ، مرتخي ولم يتنفس بعد الولادة ما الواجب عمله ؟', type: 'mc', options: [{ id: 'a', text: 'تجفيف الطفل جيدا .' }, { id: 'b', text: 'هز الطفل.' }, { id: 'c', text: 'صب الماء البارد على الوجه .' }, { id: 'd', text: 'حمل الطفل من قدميه مقلوبا .' }], correctAnswer: 'a' },
    { id: 'q33', text: '33. ولد طفل وكان السائل الامنوسي ملوث بالعقي, ما الواجب عمله ؟', type: 'mc', options: [{ id: 'a', text: 'حفزي الطفل ثم نظف مجري الهواء .' }, { id: 'b', text: 'العقى لا يمكن استنشاقه داخل الرئتين .' }, { id: 'c', text: 'نظفي مجري الهواء بعد تجفيف الطفل' }, { id: 'd', text: 'نظفي مجري الهواء قبل تجفيف الطفل .' }], correctAnswer: 'd' },
    { id: 'q34', text: '34. ماذا يجب ان تفعلي في الدقيقة الذهبية ؟', type: 'mc', options: [{ id: 'a', text: 'تحميم الطفل' }, { id: 'b', text: 'احراج المشيمة' }, { id: 'c', text: 'تقييم ضربات القلب' }, { id: 'd', text: 'مساعدة الوليد على التنفس اذا لزم .' }], correctAnswer: 'd' },
    { id: 'q35', text: '35. مولود صامت ومرتخي ولا يصرخ ولا يستجيبق لخطوات تحفيز التنفس ما الواجب عمله ؟', type: 'mc', options: [{ id: 'a', text: 'اصفع الطفل علي ظهره .' }, { id: 'b', text: 'احمل الطفل من قدميه مقلوبا.' }, { id: 'c', text: 'اضغط على ضلوع الطفل .' }, { id: 'd', text: 'ابدأ التهوية .' }], correctAnswer: 'd' },
    { id: 'q36', text: '36. أي الجمل الاتية صحيحة فيما يختص التهوية بواسطة الكيس والقناع ؟', type: 'mc', options: [{ id: 'a', text: 'يجب ان يغطي القناع العينين .' }, { id: 'b', text: 'يجب ان يتسرب الهواء بين القناع والوجه .' }, { id: 'c', text: 'اضغطي الكيس لينتج حركة صدر هادئة .' }, { id: 'd', text: 'اضغطي الكيس ليعطي 80-100 نفسا / الدقيقة .' }], correctAnswer: 'c' },
    { id: 'q37', text: '37. اي العلامات التالية يتوجب مراقبتها في الطفل اثناء الساعاتن الأولي بعد الولادة ؟', type: 'mc', options: [{ id: 'a', text: 'الطول' }, { id: 'b', text: 'التنفس' }, { id: 'c', text: 'الابتسام' }, { id: 'd', text: 'معدل اخراج البول .' }], correctAnswer: 'b' },
    { id: 'q38', text: '38. طفل وليد لم يتحرك صدره بعد تطبيق التهوية بالكيس والقناع . ما الواجب عمله ؟', type: 'mc', options: [{ id: 'a', text: 'ايقاف التهوية .' }, { id: 'b', text: 'اعادة احكام القناع واغلاقه .' }, { id: 'c', text: 'صفع الطفل غلي ظهره .' }, { id: 'd', text: 'اعطاء الطفل العقاقير الطبية.' }], correctAnswer: 'b' },
    { id: 'q39', text: '39. يمكن ايقاف عملية التهوية اذا :', type: 'mc', options: [{ id: 'a', text: 'كان لون الطفل ازرق ومرتخي .' }, { id: 'b', text: 'كانت ضربات قلب الطفل 80 نبضة / الدقيقة .' }, { id: 'c', text: 'كانت ضربات قلب الطفل 120 نبضة / الدقيقة والصدر لا يتحرك .' }, { id: 'd', text: 'كانت ضربات قلب الطفل 120 نبضة / الدقيقة والطفل يتنفس ويصرخ.' }], correctAnswer: 'd' },
    { id: 'q40', text: '40. ماذا تفعلين لتوفير الدفء للوليد ؟', type: 'mc', options: [{ id: 'a', text: 'فتح كل النوافز لتجديد دخول الهواء الدافئ.' }, { id: 'b', text: 'تحميم الطفل بعد الولادة .' }, { id: 'c', text: 'وضع زجاجات الماء الساخن لتلاصق بشرة الوليد .' }, { id: 'd', text: 'وضع الطفل جلد ابجلد مع الام .' }], correctAnswer: 'd' },
    { id: 'q41', text: '41. ماذا تفعلين لابقاء الوليد نظيفا ؟', type: 'mc', options: [{ id: 'a', text: 'اغسلي يديك قبل ان تلمسي الطفل وساعدي الام على غسل يديها قبل الرضاعة .' }, { id: 'b', text: 'اعدي استعمال جهاز الشفاط قبل النظافة .' }, { id: 'c', text: 'ابقي على الحبل السري مغطي باحكام ؟' }, { id: 'd', text: 'لا تلمسي الطفل' }], correctAnswer: 'a' },
    { id: 'q42', text: '42. معدل نبض الطفل الوليد ؟', type: 'mc', options: [{ id: 'a', text: 'اسرع من نبضك.' }, { id: 'b', text: 'ابطأ من نبضك .' }, { id: 'c', text: 'مساوي لنبضك' }], correctAnswer: 'a' }
];
