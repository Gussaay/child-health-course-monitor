...
export function PublicCourseMonitoringView({ course, allParticipants }) {
    ...
    return (
        <div className="space-y-6 max-w-5xl mx-auto p-4">
            {/* A mentorship course goes straight to the form. The practice tab
                carries its own participant picker in the session setup, so this
                header would only repeat the course type and push the form down
                the page. Every other course type keeps it. */}
