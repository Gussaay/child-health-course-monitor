// IMNCIVisitReport.jsx
import React, { useState, useMemo, Suspense } from 'react';
import { getAuth } from "firebase/auth";
import { Timestamp } from 'firebase/firestore';
import { uploadFile, deleteFile, saveIMNCIVisitReport } from '../data.js';
import { 
    Card, 
    PageHeader, 
    Button, 
...
// --- NEW: IMNCI Visit Report Component ---
const IMNCIVisitReport = ({ facility, onCancel, setToast, allSubmissions, existingReportData = null }) => {
    const auth = getAuth();
    ...
    // Filter sessions for this facility and visit date
    ...
    // --- (FIXED) Handlers for Multiple Images ---

    // (FIXED) Updated to handle multiple file selection
    ...
    // Removes an *existing* image (URL) from formData
    ...
    // Removes a *new* image (File object) from newImageFiles
    ...
    return (
        <Suspense fallback={<div className="p-8"><Spinner /></div>}> {/* Add Suspense boundary */}
            <Card dir="rtl">
                <form onSubmit={handleSubmit}>
                    <div className="p-6 text-right">
                        
                        {/* --- 1: Title Centered (FIXED) --- */}
                        ...
                        {/* --- 3: Table columns REVERSED as requested --- */}
                        <div className="mb-6">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="mt-2 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                ...
                                {/* 1. Render existing images (from formData.imageUrls) */}
                                ...
                                {/* 2. Render new images (from newImageFiles) */}
                                ...
                                >
                                    <div className="text-center">
                                        ...
                                        <Input 
                                            ...
                                            multiple // <-- (FIXED) Added multiple attribute
                                        />
                                    </div>
                                </label>
                            </div>
                    ...
                    </div> {/* End of the "p-6 text-right" div */}

                    {/* Button Bar */}
                    <div className="flex flex-col gap-2 items-end p-4 border-t bg-gray-50 sticky bottom-0 z-10">
                        <div className="flex gap-2 flex-wrap justify-start"> {/* justify-start = right in RTL */}
...
export default IMNCIVisitReport;