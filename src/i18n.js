    ...
    translation: {
      ...
      dashboard: {
        ...
        table: {
          ...
          imnci_register: "IMNCI Register",
          imnci_registers: "IMNCI Registers",
          chart_booklet: "Chart Booklet",
          imnci_chartbooklet: "IMNCI Chart Booklet",
          weight_scale: "Weight Scale",
          height_scale: "Height Scale",
          thermometer: "Thermometer",
          timer: "Timer",
          ort_corner: "ORT Corner",
          total_functioning_phcs: "Total PHCs",
    ...
    translation: {
      ...
      dashboard: {
        ...
        cards: {
          ...
          functioning_scnu: "وحدات  الرعاية الخاصة للاطفال حديثي الولادة العاملة",
          facilities_with_cpap: "مؤسسات تتوفر بها أجهزة التنفس الصناعي بالضغط الهوائي المستمر CPAP",
          total_emonc: "إجمالي مؤسسات طوارئ الولادة",
          functional_emonc: "مؤسسات طوارئ الولادة العاملة",
          eenc_coverage_functional: "تغطية الرعاية الضرورية المبكرة للاطفال حديثي الولادة في المؤسسات العاملة",
          total_functioning_phc: "إجمالي مراكز الرعاية الأساسية العاملة",
          total_phc_imnci: "مراكز الرعاية الأساسية المطبقة لـ العلاج المتكامل لامراض الطفولة",
          imnci_coverage_phc: "تغطية العلاج المتكامل لامراض الطفولة في الرعاية الأساسية",
          target_hospitals_etat: "المستشفيات المستهدفة (الفرز والتقييم والمعالجة للاطفال في الطوارئ)",
          hospitals_etat: "مستشفيات تتوفر بها الفرز والتقييم والمعالجة للاطفال في الطوارئ",
          facilities_hdu: "مؤسسات تتوفر بها عناية وسيطة للاطفال",
          facilities_picu: "مؤسسات تتوفر بها العناية المكثفة PICU",
          out_of: "من أصل"
        },
        headers: {
          scnu_coverage: "تغطية الرعاية الخاصة للاطفال حديثي الولادة (الحضانة) حسب",
          neonatal_equipment: "توفر معدات وحدات حديثي الولادة",
          functioning_neonatal_units: "قائمة وحدات  الرعاية الخاصة للاطفال حديثي الولادة (SCNU) العاملة",
          eenc_coverage: "تغطية الرعاية الضرورية المبكرة للاطفال حديثي الولادة حسب",
          eenc_equipment: "توفر معدات الرعاية الضرورية المبكرة للاطفال حديثي الولادة بالوحدة",
          imnci_coverage: "تغطية العلاج المتكامل لامراض الطفولة حسب",
          imnci_tools: "توفر أدوات العلاج المتكامل لامراض الطفولة حسب",
        ...
        table: {
          ...
          with_scnu: "تطبق الرعاية الخاصة للاطفال حديثي الولادة (الحضانة)",
          coverage_chart: "مخطط التغطية",
          incubators: "الحضانات",
          cots: "الأسرة",
          total_beds: "إجمالي الأسرة",
          functional_emonc: "طوارئ ولادة عاملة",
          with_eenc: "تطبق الرعاية الضرورية المبكرة للاطفال حديثي الولادة",
          functioning_phcs: "مراكز عاملة",
          phcs_with_imnci: "مراكز تطبيق العلاج المتكامل",
          target_hospitals: "المستشفيات المستهدفة",
          with_hdu: "تطبق العناية الوسيطة للاطفال",
          with_picu: "تطبق العناية المكثفة للاطفال",
          with_etat: "تطبق الفرز والتقييم والمعالجة للاطفال في الطوارئ",
          overall_average: "المتوسط الكلي",
          imnci_register: "سجل العلاج المتكامل",
          imnci_registers: "سجلات العلاج المتكامل",
          chart_booklet: "كتيب اللوحات",
          imnci_chartbooklet: "كتيبات لوحات العلاج المتكامل",
          weight_scale: "ميزان وزن",
          height_scale: "مقياس طول",
          thermometer: "مقياس حرارة",
          timer: "ساعة مؤقت",
          ort_corner: "زاوية إرواء",
          total_functioning_phcs: "إجمالي المراكز العاملة",
        ...
        equip: {
            ...
            "CPAP Machines": "أجهزة تنفس صناعي بالضغط الهوائي المستمر CPAP",
            "Mechanical Ventilators": "أجهزة تنفس صناعي",
            "Neonatal Warmers": "دفايات لحديثي الولادة",
            "Infusion Pumps": "مضخات سوائل",
            "Syringe Pumps": "مضخات حقن",
            "Suction Devices": "أجهزة شفط",
            "Resuscitation Bags": "امبوباق",
            "Portable Incubators": "دفايات محمولة",
            "Delivery Beds": "سرير ولادة",
            "Resuscitation Stations": "محطات إنعاش",
            "Warmers": "دفايات",
            "Ambu Bags": "أمبوباق",
            "Manual Suction": "شفاط يدوي",
            "Wall Clock": "ساعة حائط",
            "Steam Sterilizer": "معقم بخاري",
            "ETAT CPAP": "CPAP طوارئ",
            "ETAT Suction": "شفاط طوارئ",
            "HDU Beds": "أسرة عناية وسيطة",
            "HDU CPAP": "CPAP عناية وسيطة",
            "PICU Beds": "أسرة عناية مكثفة"
        }
      },
      landing: {
        welcome: "مرحباً",
